...
question(
    '(Who|What) are you',
    reply(
        'I\'m Hardy, diet hard\'s virtual agent',
        'I\'m Hardy, diet hard\'s virtual agent. What can I help you with?',
    ),
);
...
question(
    ...
    'What is your age',
    'Are you (young|old)',
    reply('My creator created me during a hackathon. (But I have timeless wisdom|)'),
);
...
question(
    ...
    'When were you born',
    reply('I was born this very month. Terrific trio created me'),
);
...
question(
    'Who is your boss',
    reply(
        'My boss is the one who programmed me, The terrific trio. (But you\'re my boss right now|)',
...
question(
    ...
    reply(
        ...
        'I\'m an advanced AI',
        'I\'m not a $(Q chatbot), I\'m Hardy (your virtual agent|).',
    ),
);
...
question(
    'My name is $(NAME)',
    reply('(Nice to meet you|Hi|Hello) $(NAME) (I\'m Hardy|my name is Hardy|)'),
);
...
question(
    ...
    reply('I\'m Hardy, a virtual agent, (within this application.|) (I can help you get what you need|I can help you with anything within my programming).'),
);
...
question(
    ...
    'Who are you?',
    reply(
        '(My name is|It\'s) Hardy, what\'s yours?',
        follow(
...
question(
    ...
    reply(
        'I\'m not $(Q), I\'m Hardy, my developer is trying to make me better than $(Q)',
        'You must be thinking of someone else. I\'m Hardy, not $(Q)',
    ),
);
...
question(
    '(Exactly|) what (necessary|) function does this website provide (for its users |)',
    'Tell me about this website',
    'What does this website do',
    
    reply(
        'Here at Diet hard , all the meal prep plans are heavily personalized and customizable to make sure the user attains his/her fitness goals . The key focus of thought for our website is that we understand the diversity of Indian cuisines and how intimately the cultural identity of each and every state is tied up with its cuisines and food .Thus , we have categorized the Indian dishes into local ,  state wise dishes . The user can choose from a wide variety of dishes of his/her own preferred locality (Maharastrian , Gujarathi , Goan etc) and the algorithm sets up their meal plan amongst the chosen category with caloric and macro nutrient constraints . Weekly diet analysis and very detailed nutrient tracker is also provided .Dont like the daily meal plan the algorithm has setup ? Dont worry, the daily meal plan can be customised any time where you can choose food from any locality and add any dish according to your liking !' ),
);
 question(
    'Which problems or obstacles the user amongst the targeted demographic would have to face in his/her journey if he were NOT to use the application',
    reply(
        'Most of the online resources which aid the formation of a personalized diet plans for its users , are framed to be only useful for foreign markets other than India .Practically speaking for most of the Indian consumers , these applications provide little to no use at all as the meals in the daily routine barely contain ingredients which the Indian market is familiar with. Secondly even if the food lists are optimised for Indian dishes and local food here too , the main problem our competitors make is integrating proper macro and essential micronutrient tracker and weekly analysis as a premium plan that the user has to pay for .That alienates a huge part of the key demographic the application is trying to target , as considering the economic , social and populational factors of Indian subcontinent this business model is not viable for majority of consumers .'),
);  
question(
    'targeted users',
    'who the targeted user is',
    reply(
...
question(
    ...
    'Common Activities and their caloric consumption',
    'Servings and Portions',
    reply(
        'Navigate to our lessons page for the same' ),
);
question(
    'What are calories',
    'Basics lesson',
