...
intent(`(show|what is|tell me|what's|what are|what're|read) (the|) (recent|latest|) $(N news|headlines) (in|about|on|) $(T~ ${TOPICS_INTENT})`,
    ...
    p => {
        let headlinesUrl = "https://newsapi.org/v2/top-headlines?country=in&apiKey=4c7e3d6f9d154e2a852fe233f9d57c3f";
        if (p.T.label) {
...
intent(`What does this app do?`, `How does this work?`, `What can I do here?`, `How should I use this?`,
    reply(`Here at diet hard , all the meal prep plans are heavily personalized and customizable to make sure the user attains his/her fitness goals .`));
